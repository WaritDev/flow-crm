<aside :class="sidebarCollapsed ? 'w-20' : 'w-72'"
    ...
    <div class="border-t border-slate-800 p-3 bg-slate-900">
        <div class="flex items-center justify-between">
            ...
            <a href="{{ route('profile.edit') }}" class="flex items-center gap-3 rounded-xl p-2 hover:bg-slate-800 transition-colors flex-1 overflow-hidden">
            ...
            <form method="POST" action="{{ route('logout') }}" x-show="!sidebarCollapsed">
                @csrf
                <button type="submit" class="p-2 text-slate-400 hover:text-red-400 hover:bg-slate-800 rounded-lg transition-colors" title="Log Out">
