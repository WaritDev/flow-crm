    ...
    <div class="max-w-7xl mx-auto p-4 md:p-6 space-y-6 font-sans">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
                ...
                <p class="text-slate-500 mt-1">4 customers (demo layout)</p>
            </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
            ...
            <div class="lg:col-span-8 bg-white rounded-2xl border border-gray-200 p-6 md:p-8 shadow-sm">
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            <div class="flex items-center gap-3">
                                <h1 class="text-xl font-bold text-slate-900">Alex Wong</h1>
                                <x-ui.badge status="active" />
                            </div>
                            <p class="text-slate-500 mt-1">Nickname: Jay</p>
                        </div>
                    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
                    ...
                    <x-customers.info-item label="Phone" value="081-234-5678">
                        <x-slot:icon>
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"></path></svg>
                        </x-slot:icon>
                    </x-customers.info-item>

                    <x-customers.info-item label="Province" value="Bangkok">
                        <x-slot:icon>
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"></path></svg>
                        </x-slot:icon>
                    </x-customers.info-item>

                    <x-customers.info-item label="Business type" value="Beauty clinic">
                        <x-slot:icon>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-10">
                    <x-customers.stat-box label="Lifetime value" value="THB 156,000" :isMoney="true" />
                    <x-customers.stat-box label="Deals" value="5" />
                    <x-customers.stat-box label="Last touch" value="2 days ago" subtext="Jan 17, 2024" />
                </div>

                <div>
                    <h3 class="font-bold text-slate-800 text-lg mb-4">Activity history</h3>
                    ...
                    <div class="space-y-1">
                        <div class="flex gap-4 p-3 hover:bg-slate-50 rounded-lg transition-colors">
                            ...
                            <div>
                                <p class="text-slate-800 font-medium">Sent Spa package quote</p>
                                <p class="text-sm text-slate-400">Jan 14, 2024</p>
                            </div>
                        </div>
                        ...
                        <div class="flex gap-4 p-3 hover:bg-slate-50 rounded-lg transition-colors">
                            ...
                            <div>
                                <p class="text-slate-800 font-medium">Call — promo follow-up</p>
                                <p class="text-sm text-slate-400">Jan 12, 2024</p>
                            </div>
                        </div>
                        ...
                        <div class="flex gap-4 p-3 hover:bg-slate-50 rounded-lg transition-colors">
                            ...
                            <div>
                                <p class="text-slate-800 font-medium">Closed won — treatment package</p>
                                <p class="text-sm text-slate-400">Jan 10, 2024</p>
                            </div>
                        </div>
                    </div>
                </div>
